...
public class DAOTest {
	 ...
	 * @throws simplejdbc.DAOException
	 */
	@Test @Ignore // On peut supprimer les Customer qui ont des bon de commande donc on pourras forcement supprimer des customer sans bon de commande.
        //ce test ne sert à rien vu qui gère moins de cas que le suivant.
